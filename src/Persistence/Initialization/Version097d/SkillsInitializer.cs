...
public class SkillsInitializer : SkillsInitializerBase
{
    ...
    public override void Initialize()
    {
        ...
        this.AddAreaSkillSettings(SkillNumber.Flame, false, default, default, default, true, TimeSpan.Zero, TimeSpan.FromMilliseconds(500), 0, 2, default, 0.5f, useTargetAreaFilter: true, targetAreaDiameter: 2);
        ...
        this.CreateSkill(SkillNumber.EvilSpirit, "Evil Spirit", CharacterClasses.DarkWizard, DamageType.Wizardry, 45, 6, manaConsumption: 90, energyRequirement: 220, skillType: SkillType.AreaSkillAutomaticHits);
        ...
        this.CreateSkill(SkillNumber.Cometfall, "Cometfall", CharacterClasses.DarkWizard, DamageType.Wizardry, 70, 3, manaConsumption: 150, energyRequirement: 436, elementalModifier: ElementalType.Lightning);
        ...
        this.CreateSkill(SkillNumber.Inferno, "Inferno", CharacterClasses.DarkWizard, DamageType.Wizardry, 100, manaConsumption: 200, energyRequirement: 578, elementalModifier: ElementalType.Fire, skillType: SkillType.AreaSkillAutomaticHits);
        ...
        this.CreateSkill(SkillNumber.TwistingSlash, "Twisting Slash", CharacterClasses.DarkKnight, DamageType.Physical, distance: 2, manaConsumption: 10, elementalModifier: ElementalType.Wind, skillType: SkillType.AreaSkillAutomaticHits);
        this.CreateSkill(SkillNumber.Impale, "Impale", CharacterClasses.DarkKnight, DamageType.Physical, 15, 3, manaConsumption: 8, levelRequirement: 28);
        this.CreateSkill(SkillNumber.FireBreath, "Fire Breath", CharacterClasses.DarkKnight, DamageType.Physical, 30, 3, manaConsumption: 9, levelRequirement: 110);
