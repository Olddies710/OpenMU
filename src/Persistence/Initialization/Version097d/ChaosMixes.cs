...
/// <summary>
/// Initializer for chaos mixes which are available in version 0.97d.
/// </summary>
/// <remarks>
/// This ports the classic combinations of 0.97d: Chaos weapon, Dinorant, item upgrades up to +11,
/// first and second wings and Devil Square tickets. Talismans of Luck are intentionally not supported yet.
/// </remarks>
public class ChaosMixes : InitializerBase
{
    ...
    private ItemCrafting SecondWingsCrafting()
    {
        ...
        var randomExcellent = this.Context.CreateNew<ItemCraftingRequiredItem>();
        randomExcellent.MinimumAmount = 0;
        randomExcellent.MinimumItemLevel = 4;
        randomExcellent.MaximumItemLevel = Constants.MaximumItemLevel;
        randomExcellent.NpcPriceDivisor = 40_000;
        randomExcellent.FailResult = MixResult.Disappear;
        randomExcellent.SuccessResult = MixResult.Disappear;
        randomExcellent.RequiredItemOptions.Add(this.GameConfiguration.ItemOptionTypes.First(o => o == ItemOptionTypes.Excellent));
        craftingSettings.RequiredItems.Add(randomExcellent);
        ...
        craftingSettings.ResultItems.Add(this.CreateWingResult(3)); // Wings of Spirits
        craftingSettings.ResultItems.Add(this.CreateWingResult(4)); // Wings of Soul
        craftingSettings.ResultItems.Add(this.CreateWingResult(5)); // Wings of Dragon
        craftingSettings.ResultItems.Add(this.CreateWingResult(6)); // Wings of Darkness

        return crafting;
    }

    private ItemCraftingResultItem CreateWingResult(byte wingNumber)
    {
        var result = this.Context.CreateNew<ItemCraftingResultItem>();
        result.ItemDefinition = this.GameConfiguration.Items.First(i => i.Group == 12 && i.Number == wingNumber);
        return result;
    }
}
